...
/* harmony import */ var _player_player_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../player/player.service */ "jzRL");
...
let CharacterService = class CharacterService {
    constructor(httpClient, playerService) {
        this.httpClient = httpClient;
        this.playerService = playerService;
        this.characterDataSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    }
    getCharacterData(characterId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.playerService.getPlayerData().then((data) => {
...
CharacterService.ctorParameters = () => [
    ...
    { type: _player_player_service__WEBPACK_IMPORTED_MODULE_4__["PlayerService"] }
];
...
let WelcomeComponent = class WelcomeComponent {
    constructor(characterService, router, route) {
        ...
        this.currentCharId = 4;
    }
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            //TODO get active character
            this.characterData = (yield this.characterService.getCharacterData(this.currentCharId))[0];
