...
/***/ "51sA":
/*!*****************************************************!*\
  !*** ./src/app/core/character/character.service.ts ***!
  \*****************************************************/
...
let CharacterService = class CharacterService {
    ...
    getCharacterData() {
        return new Promise((resolve, reject) => {
            resolve(this.characterDataMock);
        });
    }
};
CharacterService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var src_app_core_character_character_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/character/character.service */ "51sA");
...
let WelcomeComponent = class WelcomeComponent {
    constructor(characterService, router, route) {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.characterData = yield this.characterService.getCharacterData();
    ...
    goToSelfOrganisations() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.router.navigate(['business'], { relativeTo: this.route });
        });
    }
...
WelcomeComponent.ctorParameters = () => [
    { type: src_app_core_character_character_service__WEBPACK_IMPORTED_MODULE_5__["CharacterService"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".welcome-card, .card {\n  margin-bottom: 15px;\n  display: flex;\n  flex-direction: column;\n  min-height: 40px;\n}\n.welcome-card__info-panel, .card__info-panel {\n  display: flex;\n  flex-direction: column;\n}\n.welcome-card__info-panel__text, .card__info-panel__text {\n  font-size: 1.5em;\n  margin-top: 15px;\n  line-height: 1.15em;\n}\n.welcome-card__info-panel__text--large, .card__info-panel__text--large {\n  font-size: 2.5em;\n  align-self: center;\n}\n.welcome-card .actions, .card .actions {\n  margin-top: 15px;\n  margin: 0;\n  padding: 0;\n}\n.welcome-card .actions .actions-card-row, .card .actions .actions-card-row {\n  display: flex;\n  flex-direction: row;\n}\n.welcome-card .actions .actions-card-row:last-child, .card .actions .actions-card-row:last-child {\n  margin-right: 0;\n}\n.welcome-card .actions .actions-card-row .action-card, .card .actions .actions-card-row .action-card {\n  min-width: 20%;\n  margin-right: 1%;\n  background: #5a5661;\n}\n.welcome-card .actions .actions-card-row .action-card ::ng-deep .mat-card-header .mat-card-header-text, .card .actions .actions-card-row .action-card ::ng-deep .mat-card-header .mat-card-header-text {\n  margin: 0;\n}\n.welcome-card .actions .actions-card-row .action-card ::ng-deep .mat-badge-content, .card .actions .actions-card-row .action-card ::ng-deep .mat-badge-content {\n  right: 1%;\n  top: 1%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
