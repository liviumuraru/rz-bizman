...
const routes = [
    {
        ...
        children: [
            {
                path: 'welcome',
                loadChildren: () => Promise.all(/*! import() | modules-welcome-welcome-module */[__webpack_require__.e("default~modules-organisation-organisation-module~modules-organisation-requests-organisation-request-~c587f394"), __webpack_require__.e("default~modules-organisation-requests-organisation-request-module~modules-welcome-welcome-module"), __webpack_require__.e("modules-welcome-welcome-module")]).then(__webpack_require__.bind(null, /*! ./modules/welcome/welcome.module */ "dODg")).then(module => module.WelcomeModule),
            },
            {
                path: 'business',
                loadChildren: () => Promise.all(/*! import() | modules-organisation-organisation-module */[__webpack_require__.e("default~modules-organisation-organisation-module~modules-organisation-requests-organisation-request-~c587f394"), __webpack_require__.e("modules-organisation-organisation-module")]).then(__webpack_require__.bind(null, /*! ./modules/organisation/organisation.module */ "LxmL")).then(module => module.OrganisationModule)
            },
            //TODO change business to organisation
            {
                path: 'organisation/requests',
                loadChildren: () => Promise.all(/*! import() | modules-organisation-requests-organisation-request-module */[__webpack_require__.e("default~modules-organisation-organisation-module~modules-organisation-requests-organisation-request-~c587f394"), __webpack_require__.e("default~modules-organisation-requests-organisation-request-module~modules-welcome-welcome-module"), __webpack_require__.e("modules-organisation-requests-organisation-request-module")]).then(__webpack_require__.bind(null, /*! ./modules/organisation-requests/organisation-request.module */ "IrdP")).then(module => module.OrganisationRequestModule)
            },
            {
                path: 'organisation',
                redirectTo: 'business',
